...
import { ICodeSchema } from '../../src/json-schema-types';
...
describe('schema-linker - imports', () => {
    it('should link imported generic type definition', async () => {
        ...
        const expected: ICodeSchema = {
            type: 'object',
            definedAt: '/someProject/src/import#MyType',
            properties: {
                something: {
                    type: 'string'
                }
    ...
    it('should link 3 levels of inherited interfaces when the two top interfaces are not in the main file', async () => {
        ...
        const expected: ICodeSchema = {
            ...
            properties: {
                prop1: {
                    type: 'string',
                    inheritedFrom: '/someProject/src/import#RootInterface'
                },
                prop2: {
                    type: 'string',
                    inheritedFrom: '/someProject/src/import#ChildInterface'
                },
                prop3: {
                    type: 'string'
                }

...
import { ICodeSchema, InterfaceSchemaId } from '../../src/json-schema-types';
...
describe('schema-linker - interfaces', () => {
    ...
    it('should flatten interface definitions 2', async () => {
        ...
        const expected: ICodeSchema = {
            ...
            linkedSchemaDependencies: ['#TypeA'],
    ...
    it('should flatten interfaces with maps and arrays', async () => {
        const fileName = 'index.ts';
        const res = await linkTest(
            {
                [fileName]: `
        ...
        export interface TypeB extends TypeA<number> {
        };
        `
            },
            'TypeB',

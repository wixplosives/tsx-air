...
function createFileModel(filePath: string, fileContents: string) {
    return editor.createModel(fileContents, undefined, Uri.parse('file://' + filePath));
}
...
export class Editor extends React.PureComponent<IEditorProps> {
    ...
    public componentDidMount() {
        ...
        this.editor!.setModel(
            createFileModel(this.props.filePath, this.props.fs.readFileSync(this.props.filePath, 'utf8'))
        );
    ...
    private handleResize = () => {
        window.cancelAnimationFrame(this.resizeRequestId);
        this.resizeRequestId = window.requestAnimationFrame(() => this.editor!.layout());
    };

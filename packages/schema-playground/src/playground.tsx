...
import { transform } from '@wixc3/typescript-schema-extract';
import { extractSchema as extractStylableSchema } from '@stylable/schema-extract';
import { BaseView as BaseSchemaView, defaultSchemaViewRegistry } from '@wixc3/schema-views/src';
...
export class Playground extends React.PureComponent<IPlaygroundProps, IPlaygroundState> {
    ...
    private extractTypescriptSchema() {
        ...
        const moduleSchema = transform(typeChecker, sourceFile, filePath, '/', this.props.fs.path);
        const schema =
            moduleSchema.properties && moduleSchema.properties.default ? moduleSchema.properties.default : moduleSchema;
        return schema;
    }
    ...
    private extractStylableSchema() {
        ...
        return extractStylableSchema(fileContents, filePath, '/', fs.path);
    }
}
